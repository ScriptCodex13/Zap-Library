...
Zap is an API which is designed for creating graphics applications like games with easy calls but still control over the OpenGL processes behind the scenes. 
